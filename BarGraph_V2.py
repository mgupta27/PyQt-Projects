...
# https://www.youtube.com/watch?v=l9-BZuW-cXU
# https://www.geeksforgeeks.org/pyqtgraph-getting-name-of-bar-graph/?ref=lbp
...
class Window(QMainWindow):
	...
	def UiComponents(self):
		...
		bargraph = pg.BarGraphItem(x = x, y = y1, height = 100, width = 0.6, brush ='g')
